...
export default function AdminCallHistoryDetailPage() {
  ...
  if (callError || !call) {
    return (
      <div className="p-8 flex flex-col items-center justify-center min-h-96 gap-3">
        ...
        <Link href="/admin/my-organizations" className="text-blue-400 hover:underline text-sm">← Back to My Organizations</Link>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
      <Link href="/admin/my-organizations" className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors text-sm group">
